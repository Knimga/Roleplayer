...
import { generateBlueprint, generateCombatReply, generateCombatEnd, buildPlayerRoster, formatFieldBlock } from "./lib/claude.js";
...
const combatsRouter = createCombatsRouter({
  ...
  generateCombatReply,
  generateCombatEnd,
  // The narrative roster never carried AC (the narrative DM has no use for
  // it); the combat DM resolves enemy attacks against it, so it's appended
  // here for combat turns only.
